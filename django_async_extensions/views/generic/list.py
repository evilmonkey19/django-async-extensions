...
class AsyncMultipleObjectTemplateResponseMixin(AsyncTemplateResponseMixin):
...
class AsyncListView(AsyncMultipleObjectTemplateResponseMixin, AsyncBaseListView):
    """
